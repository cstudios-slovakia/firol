<?php
/**
 * Požiarne vodovody — Záznam o kontrole zariadení na dodávku vody.
 *
 * @var string $number
...
<table class="hdr">
  <tr>
    ...
    <td width="43%" class="hdr-right">
      <div class="hdr-title">Záznam o kontrole zariadení na dodávku vody</div>
    ...
    <?php foreach ($items as $idx => $it):
      ...
      <tr>
        ...
        <td class="<?= $r === 'vyhovuje' ? 'res-ok' : ($r === 'nevyhovuje' ? 'res-bad' : '') ?>">
          <?= $r === 'vyhovuje' ? 'Vyhovuje' : ($r === 'nevyhovuje' ? 'Nevyhovuje' : $h($r)) ?>
        </td>
      </tr>
    <?php endforeach ?>
  </tbody>
</table>
<div class="tbl-note">Na všetkých požiarnych vodovodoch bola vykonaná kontrola označenia, dostupnosti, vybavenosti a
  funkčnosti.</div>
