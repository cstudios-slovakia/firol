...
<style>
  ...
  .stats .num { font-size: 15pt; font-weight: bold; display: block; margin-top: 1pt; text-align: center; }
...
<table class="hdr">
  <tr>
    ...
    <td width="43%" class="hdr-right">
      <div class="hdr-title">Tlaková skúška požiarnych hadíc</div>
...
<table class="stats">
  <tr>
    <td>Skúšaných hadíc<span class="num"><?= (int) $stats['total'] ?></span></td>
