...
<div class="brand-bar">
  ...
  <div class="title"><?= $h($brand['name'] ?? 'Firol') ?> · Záznam o prevádzkovej údržbe požiarnych uzáverov</div>
  <div class="subtitle">Ročná údržba (mazanie, výmena tesnení, kontrola samozatváračov)</div>
</div>
...
<h2>Zoznam udržovaných uzáverov</h2>
<table class="items">
  <thead>
    <tr>
      <th style="width: 4%">#</th>
      <th style="width: 13%">Druh</th>
      <th style="width: 13%">Označenie</th>
      <th style="width: 18%">Umiestnenie</th>
      <th style="width: 24%">Vykonané práce</th>
      <th style="width: 11%">Výsledok</th>
      <th style="width: 17%">Poznámky</th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td><?= $h($f['identifier']) ?></td>
      <td><?= $h($f['location']) ?></td>
      <td><?= nl2br($h($f['maintenance_work'])) ?></td>
