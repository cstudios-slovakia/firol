<?php
/**
 * RPHP protocol template — Záznam o kontrole RPHP.
 *
 * @var string $number
...
<table class="hdr">
  <tr>
    ...
    <td width="43%" class="hdr-right">
      <div class="hdr-title">Záznam o kontrole RPHP</div>
...
<table class="items">
  ...
  <tbody>
    <?php foreach ($items as $idx => $it): $f = $it['fields']; $st = (string) ($f['status'] ?? ''); $c = $statusColors[$st] ?? '#1a1a1f'; ?>
    <tr>
      <td><?= $idx + 1 ?></td>
