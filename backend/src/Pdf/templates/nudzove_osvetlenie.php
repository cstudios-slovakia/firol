...
<table class="stats">
  <tr>
    <td>Kontrolovaných svietidiel<br><span class="num"><?= (int) $stats['total'] ?></span></td>
...
<table class="sig-tbl">
  <tr>
    ...
    <th width="38%"><?= \Firol\Pdf\SignatureBlock::heading('nudzove_osvetlenie') ?></th>
  ...
  <tr class="sig-row">
    ...
    <td>
      <?= \Firol\Pdf\SignatureBlock::signCell($handover ?? null, 'nudzove_osvetlenie') ?>
    </td>
    <td></td>
  </tr>
</table>
