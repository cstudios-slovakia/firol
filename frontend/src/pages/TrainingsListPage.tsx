...
import {
  Building2, CalendarDays, Edit2, GraduationCap, Plus, Search, Trash2, User, Users, Warehouse,
} from 'lucide-react';
import {
    ...
    <div className="flex flex-col gap-4">
      ...
      {filtered && filtered.length > 0 && (
        <ul className="flex flex-col gap-2">
          {filtered.map((it) => (
            <li key={it.id}>
              <TrainingRow it={it} onDelete={setPendingDeleteId} />
            </li>
          ))}
        </ul>
      )}
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            <Badge tone={it.status === 'finalized' ? 'ok' : 'warn'} className="shrink-0">
